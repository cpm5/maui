	...
	public partial class ResourceDictionaryWithSource : ContentPage
	{
		...
		public class Tests
		{
			...
			public void LoadResourcesWithAssembly(bool useCompiledXaml)
			{
				...
				Assert.That(((ResourceDictionary)layout.Resources["inOtherAssembly"]).Source, Is.EqualTo(new Uri("/Xaml/AppResources.xaml;assembly=Microsoft.Maui.Controls.Core.UnitTests", UriKind.Relative)));
